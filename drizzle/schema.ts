...
/**
 * Tabla puente N a N entre productos y grupos de modifiers.
 * Permite que el grupo "Salsas" se reutilice en multiples productos
 * (tacos, quesadillas, etc) sin duplicar las opciones.
 */
