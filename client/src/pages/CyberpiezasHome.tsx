// >>> ESTE ARCHIVO VA EN: client/src/pages/CyberpiezasHome.tsx <<<
...
// ============================================================================
// HERO — Corto y directo. Lo importante: entrar al sistema o ver los POS.
// ============================================================================
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">Acciones rapidas para gestionar CyberPiezas</p>
          </div>
          {pendingCount > 0 && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <h3 className="font-bold text-base text-slate-900 mb-1">Gestion usuarios</h3>
          ...
          >
            ...
            <p className="text-xs text-white/80">Ver catalogo completo de suscripciones</p>
        ...
        <div className="sticky top-0 bg-white border-b border-slate-100 px-6 py-4 flex items-center justify-between rounded-t-3xl z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Acciones rapidas de administracion</p>
            </div>
          </div>
          ...
          {pendingCount > 0 && (
            <div className="flex items-center gap-3 px-4 py-3 bg-rose-50 border-2 border-rose-200 rounded-2xl">
              ...
              <span className="text-sm font-bold text-rose-700">
                Tienes {pendingCount} pago{pendingCount !== 1 ? "s" : ""} esperando aprobacion
              </span>
            </div>
          )}
  ...
  return (
    <div className="w-full aspect-[21/10] sm:aspect-[2.1/1] relative">
      <svg viewBox="0 0 840 400" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="420" y="205" textAnchor="middle" fill="#0c1426" fontFamily="Georgia, serif" fontSize="18" fontStyle="italic">CyberPiezas</text>
      </svg>
    </div>
  );
}
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
          <div className="group bg-white rounded-3xl p-7 border border-slate-200/60 hover:border-teal-200 hover:shadow-2xl hover:shadow-teal-500/10 hover:-translate-y-1 transition-all">
            ...
            <h3 className="text-2xl font-bold tracking-tight text-slate-900 mb-3">Economica</h3>
            <p className="text-sm text-slate-600 mb-5 leading-relaxed">
              Para tu negocio. Cobrar, operar, crecer. Veterinarias, boutiques, abarrotes y mas.
            </p>
          </div>
          ...
          <div className="group bg-white rounded-3xl p-7 border border-slate-200/60 hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-1 transition-all">
            ...
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400 mb-2">Tipo de confianza</p>
            <h3 className="text-2xl font-bold tracking-tight text-slate-900 mb-3">Fisica y social</h3>
            <p className="text-sm text-slate-600 mb-5 leading-relaxed">
          ...
          <div className="group bg-white rounded-3xl p-7 border border-slate-200/60 hover:border-orange-200 hover:shadow-2xl hover:shadow-orange-500/10 hover:-translate-y-1 transition-all">
            ...
            <p className="text-sm text-slate-600 mb-5 leading-relaxed">
              Celine, ofertas y trueques locales. Le vendes a tu vecino, no a un desconocido del otro lado del pais.
            </p>
          </div>
        </div>
      </div>
    ...
    <section id="casas" className="bg-white py-16 sm:py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16 lg:mb-20">
          ...
          <p className="mt-6 text-base sm:text-lg lg:text-xl text-slate-600 max-w-2xl mx-auto font-light leading-relaxed">
            Cada producto es completo y tiene su propia app. Pero todos comparten quien eres y la confianza que has construido.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-5">
          <button
            ...
            className="group relative bg-gradient-to-br from-blue-50 via-white to-white rounded-3xl p-7 sm:p-9 border border-blue-100 hover:border-blue-300 hover:shadow-2xl hover:shadow-blue-500/15 hover:-translate-y-1 transition-all overflow-hidden flex flex-col text-left w-full cursor-pointer"
          >
            ...
            <div className="flex items-center justify-end pt-4 border-t border-blue-100 mt-auto">
          ...
          <a
            href="#celine"
            id="celine"
            className="group relative bg-gradient-to-br from-orange-50 via-white to-white rounded-3xl p-7 sm:p-9 border border-orange-100 hover:border-orange-300 hover:shadow-2xl hover:shadow-orange-500/15 hover:-translate-y-1 transition-all overflow-hidden flex flex-col"
          >
            ...
            <p className="text-slate-600 mb-5 leading-relaxed text-sm">
              Plataforma abierta donde vecinos venden, regalan o truequean. Sin cuotas. Con un modulo especial para productores rurales.
            </p>
            <div className="flex items-center justify-end pt-4 border-t border-orange-100 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16 lg:mb-20">
          ...
          <p className="mt-6 text-base sm:text-lg text-slate-600 max-w-2xl mx-auto font-light leading-relaxed">
            Cada sistema esta hecho a la medida del giro. Sin funciones que no usas, sin pagar por lo que no necesitas.
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 p-6 sm:p-10 lg:p-14 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-100 text-emerald-700 text-[10px] font-bold rounded-full mb-4 sm:mb-5 uppercase tracking-[0.2em]">
                <Stethoscope className="w-3 h-3" /> Premium
              </div>
...
function TrustLayer() {
  const steps = [
    { num: "01", title: "Te conocemos", desc: "Empiezas con tu correo. Si quieres, verificas telefono. Despues INE. Cada paso es opcional y te abre nuevas puertas." },
    { num: "02", title: "Participas", desc: "Compartes un viaje en Mobility, vendes algo en Celine, abres tu negocio con POS. Cada actividad deja huella." },
    { num: "03", title: "Tu comunidad respalda", desc: "Personas reales con las que has interactuado escriben sobre ti. Sin estrellas, sin numeros. Solo lo que paso." },
    { num: "04", title: "Te acompana", desc: "Tu identidad vive en una sola cuenta. Tu reputacion se interpreta segun cada casa." },
  ];
  return (
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16 lg:mb-20">
          <div className="inline-flex items-center gap-2 text-xs font-bold text-amber-700 uppercase tracking-[0.25em] sm:tracking-[0.3em] mb-5 sm:mb-6">
            ...
            <span className="w-6 h-px bg-amber-400" />
            <span>Como se construye la confianza</span>
          </div>
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tighter text-slate-900 max-w-3xl mx-auto leading-[1.05] sm:leading-[1.0]">
            No es un score.
            <br />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {steps.map((step) => (
            <div key={step.num} className="bg-white rounded-3xl p-7 border border-slate-200/60 hover:border-slate-300 hover:shadow-xl hover:-translate-y-1 transition-all">
...
function Communities() {
  const sectors = [
    { emoji: "🎓", name: "Estudiantes", desc: "Universitarios y de prepa. Rutas compartidas, libros usados, tutorias." },
    { emoji: "💜", name: "Mujeres", desc: "Comunidad verificada con modo discreto por default. Privacidad extra fuerte." },
    { emoji: "🌽", name: "Productores", desc: "Campesinos, ganaderos y artesanos de Morelos. Comercio directo, sin coyotes." },
    { emoji: "🏘️", name: "Vecinos", desc: "Personas que comparten colonia. Trueques, ofertas y recomendaciones." },
    { emoji: "🏢", name: "Negocios locales", desc: "Comercios independientes de Morelos. Validados, recomendados, conectados." },
    { emoji: "🎵", name: "Musicos y artistas", desc: "Para agrupaciones, solistas y eventos. Donde la tarima encuentra al publico." },
    { emoji: "🌄", name: "Turismo", desc: "Anfitriones, guias y comunidad receptora. Movilidad y descubrimiento responsable." },
  ];
  return (
    <section id="comunidades" className="bg-white py-16 sm:py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tighter text-slate-900 max-w-3xl mx-auto leading-[1.05] sm:leading-[1.0]">
            Aqui no eres{" "}
            <span className="font-serif italic text-slate-400 font-medium">un usuario mas.</span>
            <br />
            Eres parte de algo.
          </h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {sectors.map((s) => (
            <div key={s.name} className="group relative bg-white rounded-2xl p-6 border border-slate-200/60 hover:border-amber-200 hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer overflow-hidden">
...
function WhyDifferent() {
  const reasons = [
    { num: "i.", title: "Tu reputacion no es un numero.", desc: "No hay 8.7/10 puntos de confianza. Hay personas reales describiendo lo que paso contigo. La confianza se gana con hechos, no con algoritmos." },
    { num: "ii.", title: "Tus datos no son nuestro negocio.", desc: "No vendemos informacion. No mostramos publicidad. No rastreamos tus habitos. Lo que ganamos viene de quienes usan nuestro POS." },
    { num: "iii.", title: "Crecemos lento. A proposito.", desc: "Densidad antes que escala. Si las primeras 100 personas no se sienten seguras, no vale la pena tener 10,000." },
    { num: "iv.", title: "Soporte humano, no chatbots.", desc: "Cuando algo no sale bien, te responde una persona, no un bot. En espanol. Por WhatsApp. Rapido y cercano." },
    { num: "v.", title: "Hecho en casa.", desc: "El codigo se escribe en Morelos. Los datos viven en servidores que cumplen LFPDPPP. Los problemas los resuelve gente que conoce el contexto local." },
  ];
  return (
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 text-xs font-bold text-slate-600 uppercase tracking-[0.25em] sm:tracking-[0.3em] mb-5 sm:mb-6">
            ...
            <span className="w-6 h-px bg-slate-300" />
            <span>Por que somos distintos</span>
          </div>
        ...
        <div className="space-y-0">
          {reasons.map((r, i) => (
            <div key={i} className="grid grid-cols-[40px_1fr] sm:grid-cols-[64px_1fr] gap-4 sm:gap-7 py-7 sm:py-8 border-b border-slate-200 last:border-b-0">
...
function Services() {
  const services = [
    ...
    { icon: MessageCircle, title: "Soporte WhatsApp", price: "$299/mes", desc: "Atencion humana, rapida y cercana", gradient: "from-rose-500 to-red-500" },
  ];
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {features.map((f, i) => {
            const Icon = f.icon;
            return (
              <div key={i} className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 border border-slate-200/60 hover:border-slate-300 hover:shadow-xl hover:shadow-slate-900/5 hover:-translate-y-1 transition-all flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm sm:text-base font-bold tracking-tight text-slate-900 mb-1">{f.title}</h3>
            ...
            {isAuthenticated && referralCode ? (
              <div className="max-w-md mx-auto">
                ...
                <div className="bg-slate-50 rounded-xl p-3 mb-4 border border-slate-200">
                  <p className="text-xs text-slate-500 mb-1 text-left">Tu link unico:</p>
                  <p className="text-xs text-slate-700 break-all text-left font-mono">
                    {referralLink}
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row gap-2">
                  <Button onClick={handleCopy} className="flex-1 bg-slate-900 hover:bg-slate-800 text-white rounded-full h-11 font-semibold">
                    {copied ? (<><Check className="w-4 h-4 mr-1.5" /> Copiado!</>) : (<><Mail className="w-4 h-4 mr-1.5" /> Copiar link</>)}
                  </Button>
                  <Button onClick={handleWhatsApp} className="flex-1 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full h-11 font-semibold">
...
function Pricing({ setLocation, isAuthenticated }: { setLocation: (p: string) => void; isAuthenticated: boolean }) {
  const systems = [
    { code: "boutique", name: "Boutique", icon: "👗", price: 300, yearly: 3000, desc: "POS para tiendas de ropa, accesorios y moda.", features: ["Productos ilimitados", "Variantes (talla/color)", "Multiples sucursales", "Reportes en tiempo real", "Soporte WhatsApp"], gradient: "from-rose-500 to-pink-600", accent: "rose" },
    { code: "abarrotes", name: "Abarrotes", icon: "🛒", price: 300, yearly: 3000, desc: "POS para tienditas, miscelaneas y minisupers.", features: ["Codigos de barras", "Inventario ilimitado", "Ventas con fiado", "Reportes diarios", "Soporte WhatsApp"], gradient: "from-amber-500 to-orange-600", accent: "amber" },
    { code: "veterinaria", name: "Veterinaria", icon: "🐾", price: 300, yearly: 3000, desc: "POS para clinicas veterinarias completas.", features: ["Expediente de mascotas", "Citas y vacunacion", "Productos + servicios", "Recibos profesionales", "Soporte WhatsApp"], gradient: "from-emerald-500 to-teal-600", accent: "emerald" },
    { code: "verduleria", name: "Verduleria", icon: "🥕", price: 300, yearly: 3000, desc: "POS para frutas, verduras y mercados.", features: ["Catalogo visual", "Venta por peso", "Stock perecedero", "Ventas rapidas", "Soporte WhatsApp"], gradient: "from-green-500 to-emerald-600", accent: "green" },
    { code: "tarima", name: "Tarima", icon: "🎤", price: 150, yearly: 1500, desc: "Plataforma para artistas, musicos y bandas.", features: ["Perfil publico con tu URL", "Galeria de fotos y videos", "Musica de Spotify", "Reservaciones online", "Soporte WhatsApp"], gradient: "from-fuchsia-500 to-purple-600", accent: "fuchsia", featured: true },
  ];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-slate-600 font-light px-2 mb-2">
            Una suscripcion por cada sistema que necesites.
          </p>
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex items-center bg-white border border-slate-200 rounded-full p-1 shadow-md">
            <button onClick={() => setBillingType("monthly")} className={"px-5 py-2 rounded-full text-sm font-semibold transition-all " + (billingType === "monthly" ? "bg-slate-900 text-white shadow" : "text-slate-600 hover:text-slate-900")}>
              Mensual
            </button>
            <button onClick={() => setBillingType("yearly")} className={"px-5 py-2 rounded-full text-sm font-semibold transition-all relative " + (billingType === "yearly" ? "bg-slate-900 text-white shadow" : "text-slate-600 hover:text-slate-900")}>
              Anual
              <span className="absolute -top-2 -right-2 bg-emerald-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full">AHORRA</span>
            </button>
          </div>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {systems.map((sys) => {
            ...
            const period = billingType === "monthly" ? "/mes" : "/ano";
            return (
              <div key={sys.code} className={isPremium ? "bg-slate-900 text-white rounded-2xl sm:rounded-3xl p-6 sm:p-7 shadow-2xl shadow-slate-900/30 relative md:scale-[1.02] sm:col-span-2 lg:col-span-1 ring-2 ring-fuchsia-500/30" : "bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-7 border border-slate-200 hover:border-slate-300 hover:shadow-xl transition-all"}>
                {isPremium && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-gradient-to-r from-fuchsia-400 to-purple-500 text-white text-xs font-bold rounded-full shadow-lg">NUEVO</div>
                )}
                <div className={"w-14 h-14 rounded-2xl flex items-center justify-center text-3xl mb-4 " + (isPremium ? "bg-white/10 ring-2 ring-fuchsia-400/40" : `bg-gradient-to-br ${sys.gradient}/10`)}>
                  {sys.icon}
                </div>
                <h3 className={"text-xl font-bold mb-1 tracking-tight " + (isPremium ? "text-white" : "text-slate-900")}>{sys.name}</h3>
                <p className={"text-sm mb-5 " + (isPremium ? "text-slate-400" : "text-slate-600")}>{sys.desc}</p>
                <div className="mb-5">
                  <span className={"text-4xl font-bold tracking-tight " + (isPremium ? "text-white" : "text-slate-900")}>
                    ${price.toLocaleString("es-MX")}
                  </span>
                  <span className={"text-sm ml-1 " + (isPremium ? "text-slate-400" : "text-slate-500")}>{period}</span>
                </div>
                <Button
                  onClick={() => { if (isAuthenticated) { setLocation("/pricing"); } else { window.location.href = getLoginUrl(); } }}
                  className={isPremium ? "w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 hover:from-fuchsia-600 hover:to-purple-700 text-white rounded-full h-10 font-semibold mb-5 text-sm shadow-lg" : "w-full bg-slate-900 hover:bg-slate-800 text-white rounded-full h-10 font-semibold mb-5 text-sm"}
                >
                  {isAuthenticated ? "Suscribirme" : "Empezar ahora"}
                </Button>
                <ul className="space-y-2">
                  {sys.features.map((f, i) => (
                    <li key={i} className={"flex items-start gap-2 text-sm " + (isPremium ? "text-slate-200" : "text-slate-700")}>
                      <Check className={"w-4 h-4 flex-shrink-0 mt-0.5 " + (isPremium ? "text-fuchsia-400" : "text-emerald-500")} />
                      <span>{f}</span>
                    </li>
                  ))}
                </ul>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-slate-600 mb-4">
            Necesitas varios sistemas? Suscribete a cada uno por separado.
          </p>
          <button onClick={() => setLocation("/pricing")} className="inline-flex items-center gap-2 text-sm font-bold text-slate-900 hover:gap-3 transition-all">
        ...
        <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl sm:rounded-[2.5rem] p-8 sm:p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-7 sm:mb-10">
              ...
              <Button
                onClick={() => { const subject = encodeURIComponent("[CyberPiezas] Quiero conocer mas"); window.location.href = "mailto:cyberpiezas207@gmail.com?subject=" + subject; }}
                variant="outline"
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row justify-between gap-8 sm:gap-10">
          <div className="max-w-sm">
            ...
            <p className="text-sm text-slate-600">Infraestructura de confianza local. Hecho en Morelos, Mexico. Sin contratos. Sin algoritmos opacos. Sin venta de datos.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-600">
                <li><a href="#confianza" className="hover:text-slate-900">Como funciona</a></li>
                <li><a href="#comunidades" className="hover:text-slate-900">Comunidades</a></li>
                <li><a href="/terms" className="hover:text-slate-900">Terminos</a></li>
        ...
        <div className="border-t border-slate-100 mt-8 pt-5 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-sm text-slate-500">(c) {new Date().getFullYear()} CyberPiezas. Hecho con amor en Morelos, Mexico.</p>
...
function SupportModal({ onClose }: { onClose: () => void }) {
  ...
  const tiers = [
    ...
    { amount: 150, emoji: "🌮", name: "Una comida", description: "Energia para una jornada completa", color: "from-rose-400 to-pink-500" },
    { amount: 300, emoji: "🚀", name: "Un mes completo", description: "Equivale a una suscripcion mensual", color: "from-fuchsia-500 to-purple-600" },
  ];
  ...
  const openWhatsApp = (amount: number) => {
    const msg = encodeURIComponent(`Hola David! Quiero apoyar a CyberPiezas con $${amount} MXN. Como te lo hago llegar?`);
      ...
      <div className="bg-white rounded-t-3xl sm:rounded-3xl max-w-lg w-full shadow-2xl relative max-h-[92vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 sm:p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-slate-600">Tu apoyo nos ayuda a seguir construyendo herramientas para pequenos negocios.</p>
          </div>
          {!showThanks ? (
            <>
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-3">Elige como apoyar</h3>
            ...
            <div className="text-center py-4 mb-4 animate-in fade-in slide-in-from-bottom-2">
              ...
              <p className="text-sm text-slate-600 mb-5">
                Tu aporte de <span className="font-bold text-rose-600">${selectedTier} MXN</span> es un empujon enorme. Ahora completemos el pago:
              </p>
      ...
      <div className="bg-white rounded-t-3xl sm:rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl relative max-h-[92vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-3">
          <div>
            ...
            <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Como te llamas" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 h-11 text-slate-900 focus:border-purple-400 focus:outline-none transition-colors" />
          </div>
          <div>
            <label className="text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5 block">Email o WhatsApp *</label>
            <input value={contact} onChange={(e) => setContact(e.target.value)} placeholder="Donde podemos contactarte" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 h-11 text-slate-900 focus:border-purple-400 focus:outline-none transition-colors" />
          </div>
          <div>
            <label className="text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5 block">Mensaje</label>
            <textarea value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Cuentanos tu propuesta..." rows={3} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:border-purple-400 focus:outline-none transition-colors resize-none" />
          </div>
          <Button onClick={handleSend} className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-full h-11 font-semibold mt-2">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16 sm:mb-28 lg:mb-36">
          <div className="inline-flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-[0.25em] sm:tracking-[0.3em] mb-6 sm:mb-8">
            <span className="text-slate-300">09</span>
            <span className="w-6 h-px bg-slate-300" />
            <span>Historia</span>
          </div>
          ...
          <p className="mt-7 sm:mt-10 text-base sm:text-xl text-slate-500 max-w-xl mx-auto font-light leading-relaxed">
            No empezo como ecosistema. Empezo como una hija ayudando a su mama.
          </p>
        </div>
        <div className="space-y-16 sm:space-y-28 lg:space-y-36">
          ...
          <div className="text-center">
            <p className="text-[10px] sm:text-xs font-bold text-slate-400 uppercase tracking-[0.2em] mb-4 sm:mb-5">02 - La motivacion real</p>
            <p className="text-xl sm:text-3xl lg:text-4xl font-medium text-slate-900 leading-[1.25] sm:leading-[1.15] tracking-tight max-w-3xl mx-auto">
            ...
            <p className="mt-5 sm:mt-6 text-base sm:text-xl lg:text-2xl text-slate-600 leading-relaxed max-w-2xl mx-auto px-2">
              Su tienda de abarrotes. Le faltaba producto. Le robaban. No sabia los precios. Llegaba a casa frustrada, cansada.
            </p>
          ...
          <div className="text-center">
            ...
            <p className="mt-5 sm:mt-6 text-base sm:text-xl lg:text-2xl text-slate-600 leading-relaxed max-w-2xl mx-auto px-2">
              Bajo costo. Funcional. Pensado para los que no tienen capital, pero tienen ganas de salir adelante.
            </p>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <p className="text-xl sm:text-3xl lg:text-4xl font-medium text-slate-900 leading-[1.25] sm:leading-[1.15] tracking-tight max-w-3xl mx-auto">
              Lo que empezo como una herramienta para mi mama
              <br />
              <span className="bg-gradient-to-r from-emerald-500 via-cyan-500 to-purple-500 bg-clip-text text-transparent italic">
                se volvio algo mas grande.
              </span>
            </p>
            <p className="mt-5 sm:mt-6 text-base sm:text-xl lg:text-2xl text-slate-600 leading-relaxed max-w-2xl mx-auto px-2">
              Una red de confianza local. Donde personas, negocios y comunidades de Morelos pueden encontrarse, conocerse y cuidarse entre si.
            </p>
        ...
        <div className="mt-20 sm:mt-32 lg:mt-44 text-center">
          <div className="inline-block max-w-2xl px-3 sm:px-0">
            ...
            <div className="mt-8 flex flex-col items-center gap-1">
              <p className="text-sm font-bold text-slate-900 tracking-tight">David Antonio Farfan</p>
              <p className="text-xs text-slate-400 uppercase tracking-[0.25em]">Fundador - CyberPiezas</p>
            </div>
          </div>
        </div>
      </div>
...
export function CyberpiezasLogo({ size = 36, variant = "dark" }: { size?: number; variant?: "dark" | "light" | "transparent" }) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width={size} height={size} className="flex-shrink-0">
      <defs>
      ...
      <path d="M 142 50 A 50 50 0 1 0 142 150" fill="none" stroke={cStroke} strokeWidth="18" strokeLinecap="round" />
      <rect x="138" y="89" width="24" height="24" rx="4.5" fill={`url(#${gradId})`} transform="rotate(45 150 101)" />
