...
export function VerduleriaPOS() {
  ...
  // Hooks de proteccion: van ARRIBA de los demas hooks para respetar las
  // reglas de React (todos los hooks ejecutan en orden, sin saltos).
  // El early return que usa estos valores va DESPUES de TODOS los hooks.
  // ==========================================================================
  const [, setLocation] = useLocation();
  const { data: access, isLoading: accessLoading } =
    trpc.pagos.subscriptions.hasAccess.useQuery({ posCode: "verduleria" });
  ...
  // Acceso confirmado: renderiza el POS normal
  return (
    <DashboardLayout>
...
export default VerduleriaPOS;import { useState, useMemo } from "react";
import { useLocation } from "wouter";
import { toast } from "sonner";
import { trpc } from "@/lib/trpc";
import DashboardLayout from "@/components/DashboardLayout";
