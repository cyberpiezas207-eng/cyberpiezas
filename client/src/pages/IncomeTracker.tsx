...
export default function IncomeTracker() {
  ...
  // ── Datos para la gráfica de utilidad acumulada (últimos 30 días) ─────
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSellForm({ ...sellForm, buyerLocation: e.target.value })
                    }
                    className="mt-2"
                  />
                </div>
...
// ─── Subcomponente: Formulario completo ──────────────────────────────────
