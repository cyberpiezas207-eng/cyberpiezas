...
export default function MiTarima() {
  ...
  // mode="embedded" porque va dentro de DashboardLayout (que aporta el
  // sidebar y fondo). El AccessDeniedScreen no debe importar DashboardLayout.
  if (access && !access.hasAccess) {
    return (
      <DashboardLayout>
        <AccessDeniedScreen
          posCode="tarima"
          description="Para usar tu panel de artista necesitas estar suscrito a Tarima. Tu perfil publico, tus bookings y tu galeria viven aqui."
          benefits={[
            "Perfil publico personalizado",
            "Bookings y agenda de eventos",
            "Galeria multimedia y links",
            "$150/mes o $1,500/ano",
          ]}
          onViewPlans={() => navigateTo("/pricing?posCode=tarima")}
